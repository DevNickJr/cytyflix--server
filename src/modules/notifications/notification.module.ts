...
const ormRepo = AppDataSource.getRepository(NotificationOrmEntity);

const notificationRepository = new NotificationRepositoryImpl(ormRepo);
...
export const notificationRouter = notificationRoutes(notificationController);
