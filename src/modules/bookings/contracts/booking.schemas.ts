...
export const UpdateBookingScheduleSchema = z.object({
  body: z.object({
    ...
    message: "At least one of scheduledDate or scheduledTime must be provided",
  }),
});

export type UpdateBookingScheduleDTO = z.infer<typeof UpdateBookingScheduleSchema>["body"];
