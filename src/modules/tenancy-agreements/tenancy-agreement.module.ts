...
const agreementRepository = new TenancyAgreementRepositoryImpl(agreementOrmRepo);
...
const tenancyAgreementService = new TenancyAgreementService(agreementRepository, userRepository, propertyRepository);
const tenancyAgreementController = new TenancyAgreementController(tenancyAgreementService);

export const tenancyAgreementRouter = createTenancyAgreementRoutes(tenancyAgreementController);
