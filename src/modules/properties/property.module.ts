...
const ormRepo = AppDataSource.getRepository(PropertyOrmEntity);

const propertyRepository = new PropertyRepositoryImpl(ormRepo);

const propertyService = new PropertyService(propertyRepository);

export const propertyController = new PropertyController(propertyService);

export const propertyRouter = propertyRoutes(propertyController);
