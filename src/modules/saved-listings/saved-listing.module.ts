...
const ormRepo = AppDataSource.getRepository(SavedListingOrmEntity);

const savedListingRepository = new SavedListingRepositoryImpl(ormRepo);

const savedListingService = new SavedListingService(savedListingRepository);

export const savedListingController = new SavedListingController(
  savedListingService
);

export const savedListingRouter = savedListingRoutes(savedListingController);
